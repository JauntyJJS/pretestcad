...
Consortium 2 (CAD2) clinical and coronary calcium score (CCS) model.
Obstructive coronary artery disease was defined as \\\geq\\50% diameter
stenosis in at least one vessel found on catheter based coronary
angiography.
...
on the 2012 CAD Consortium 2 (CAD2) clinical and coronary calcium score
(CCS) model.
...
equals \$\$ \begin{array}{l} -5.975\quad+ \\\\ (0.011 \* age)\quad+ \\\\
(0.786 \* sex\\is\\male)\quad+ \\\\ (0.718 \*
have\\atypical\\chest\\pain)\quad+ \\\\ (2.024 \*
have\\typical\\chest\\pain)\quad+ \\\\ (0.658 \* have\\diabetes)\quad+
\\\\ (0.235 \* have\\hypertension)\quad+ \\\\ (0.185 \*
have\\dyslipidemia)\quad+ \\\\ (0.207 \* have\\smoking\\history)\quad+
\\\\ (0.577 \* ln(CACS + 1))\quad+ \\\\ (-0.780 \* have\\diabetes \*
