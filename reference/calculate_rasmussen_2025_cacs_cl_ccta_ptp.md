# Calculate 2025 Rasmussen CACS-CL_(CCTA) PTP model for obstructive CAD

This function returns a patient's pre-test probability (PTP) of
obstructive coronary artery disease based on 2025 Rasmussen et. al.
Coronary Artery Calcium Score-Weighted Clinical Likelihood CCTA
(RF-CL_(CCTA)) model. Obstructive CAD was defined as a stenosis causing
...
on the 2025 Rasmussen et. al. Coronary Artery Calcium Score-Weighted
Clinical Likelihood CCTA (RF-CL_(CCTA)) model.

Model formula used is from Development Table 2.

It is of the form \$\$\frac{1}{(1 + e^{-F(x)})}\$\$ where \\F(x)\\
equals \$\$ \begin{array}{l} 0.014533\quad+ \\\\ (0.27093 \*
rf\\ptp)\quad+ \\\\ (0.047056 \* cacs\\1\\to\\9)\quad+ \\\\ (0.11890 \*
cacs\\10\\to\\99)\quad+ \\\\ (0.34417 \* cacs\\100\\to\\399)\quad+ \\\\
(0.5881 \* cacs\\400\\to\\999)\quad+ \\\\ (0.73892 \*
cacs\\1000\\or\\more)\quad+ \\\\ (0.054423 \* rf\\ptp \*
cacs\\1\\to\\9)\quad+ \\\\ (0.14347 \* rf\\ptp \*
cacs\\10\\to\\99)\quad+ \\\\ (0.18439 \* rf\\ptp \*
cacs\\100\\to\\399)\quad+ \\\\ (0.085774 \* rf\\ptp \*
cacs\\400\\to\\999)\quad+ \\\\ (-0.081776 \* rf\\ptp \*
cacs\\1000\\or\\more) \end{array} \$\$
