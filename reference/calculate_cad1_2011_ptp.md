...
obstructive coronary artery disease (CAD) based on the 2011 CAD
Consortium 1 (CAD1) basic model. Obstructive CAD was defined as a
...
on the 2011 CAD Consortium 1 (CAD1) basic model.

## Details

The predictive model is based on patients from 14 hospitals in Europe
and the United States.

This model is also called the updated Diamond-Forrester model. Model
formula used is from Table 3.

It is of the form \$\$\frac{1}{(1 + e^{-F(x)})}\$\$ where \\F(x)\\
equals \$\$ \begin{array}{l} -4.37\quad+ \\\\ (0.04 \* age)\quad+ \\\\
(1.34 \* sex\\is\\male)\quad+ \\\\ (1.91 \*
have\\typical\\chest\\pain)\quad+ \\\\ (0.64 \*
have\\atypical\\chest\\pain) \end{array} \$\$
