...
Function to map an input from four different list into one of the four
standardise labels
...
- harmonise_label_four:
  ...
  Input character representing the harmonised label for `label_four`  
  Default: 'group_4'
...
#>   `chest_pain_type` must be one of "no chest pain", "normal",
#> "nonanginal", "unspecified", "atypical", "Atypical", "typical", "angina", "NA",
#> or "NaN", not "Typical".
...
#> Error in eval(expr, envir) : 
#>   `chest_pain_type` must be one of "no chest pain", "normal",
#> "nonanginal", "unspecified", "atypical", "Atypical", "typical", "angina", or
#> "NIL" not NA.
